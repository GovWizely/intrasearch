  ...
  describe '/v1/articles/count' do
    ...
    it 'returns response' do
      aggregate_failures do
        ...
        expect(parsed_body[:metadata]).to eq(total: 9)
        ...
        expected_aggregations = {
          countries: [
            ...
            { key: 'South Africa', doc_count: 2 },
            { key: 'South Korea', doc_count: 1 },
          ...
          topics: [
            { key: '/Business Management', doc_count: 3 }, 
            ...
            { key: '/Economic Development and Investment', doc_count: 2 },
          ...
          types: [
            { key: 'Country Commercial Guide', doc_count: 5 },
